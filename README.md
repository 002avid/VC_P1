...
Además de la versión pedida con círculos, se añadió una segunda versión más visual. En ella se dibuja una luna sobre una de las posiciones detectadas y un sol sobre la otra, usando elipses, líneas y círculos de OpenCV.
